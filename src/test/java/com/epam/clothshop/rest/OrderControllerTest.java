...
public class OrderControllerTest {
    ...
    public void testGetAllOrders_WhenEverythingIsOk() throws Exception {
        ...
        mockMvc.perform(get("/api/orders"))
                ...
                .andExpect(jsonPath("$[0].id", is(ORDER_1.getOrderId().intValue())))
                .andExpect(jsonPath("$[1].id", is(ORDER_2.getOrderId().intValue())))
                .andExpect(jsonPath("$[2].id", is(ORDER_3.getOrderId().intValue())));
    }
}
